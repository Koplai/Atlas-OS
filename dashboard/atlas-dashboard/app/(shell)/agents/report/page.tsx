  ...
  return (
    <div className="min-h-0 flex-1 p-4 lg:p-6">
      <div className="mb-3">
        ...
        <div className="text-xs text-slate-500">Observabilidad de sesiones/subagentes: estado, health local LLM, degradación/fallback, tokens de contexto, consumo total y costo estimado.</div>
      </div>
      <AgentsReportBoard />
    </div>
  );
